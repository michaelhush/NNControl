...
LSTM_cont = LSTM_controller(epitime = 3, timestep= 0.1, model_name='Cavity_spring')
LSTM_cont.config_lstm_para(batch_size = 32, plant_state_size = 128, cont_state_size = 128, 
                                input_size = 2, output_size = 4, learning_rate = 0.001, setout= [0.0, 0.0, 0.0, 0.0])
LSTM_cont.config_lstm()
LSTM_cont.config_noise(nF = [4.0,16.0], constant_noise= False)
LSTM_cont.initialize_variables()
iterations = 5

LSTM_cont.train_data(episodes = 1024)
LSTM_cont.train_plant(epochs = 512)
LSTM_cont.train_cont(epochs = 512)
...
LSTM_cont.save_trained_NN('CSWhite')
